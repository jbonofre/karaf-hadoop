...
/**
 * catch all throwables when initializing the default realm
 */
...
public class KerberosName {
    ...
    /**
     * An encoding of a rule for translating kerberos name.
     */
    private static class Rule {
         ...
         * @throws org.apache.hadoop.security.KerberosName.BadFormatString
         */
                ...
                if (paramNum != null) {
                    try {
                        ...
                        if (num < 0 || num > params.length) {
                            throw new BadFormatString("index " + num + " from " + format + " is outside of the value range 0 to " + (params.length - 1));
                        }
         ...
         * array.
         * @param params first element in the realm, second and later elements are
