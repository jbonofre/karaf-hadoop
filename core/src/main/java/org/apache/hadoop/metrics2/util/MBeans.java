...
/**
 * update the MBeans registration to use org.apache.hadoop
 * in order to be compliant with other Karaf MBeans
 */
...
public class MBeans {
     ...
     * "org.apache.hadoop:service=<serviceName>,name=<nameName>"
